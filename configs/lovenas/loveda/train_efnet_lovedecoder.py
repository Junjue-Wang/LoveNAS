    ...
    model=dict(
        ...
        params=dict(
            encoder=dict(
                ...
                depth=5,
                weights='imagenet',
                nas_weights_path='./logs/loveda/efnetb3_lovedecoder/efnetb3_loveda_30k.pth',
            ),
            include_os2=False,
            parse_decoder=dict(
                ...
                connect_map='./searched_archs/efnetb3_lovedecoder/c3.npy',
                ops_map='./searched_archs/efnetb3_lovedecoder/p2.npy',
            ),
            head=dict(
                in_channels=256,
                out_channels=128,
