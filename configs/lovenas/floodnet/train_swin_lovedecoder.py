    ...
    model=dict(
        ...
        params=dict(
            encoder=dict(
                ...
                nas_weights='./logs/floodnet/swinbase_lovedecoder/swinbase_floodnet_60k.pth',
            ),
            parse_decoder=dict(
                ...
                connect_map='./searched_archs/floodnet/swinbase_lovedecoder/c4.npy',
                ops_map='./searched_archs/floodnet/swinbase_lovedecoder/p3.npy',
            ),
            head=dict(
                in_channels=384,
                out_channels=128,
